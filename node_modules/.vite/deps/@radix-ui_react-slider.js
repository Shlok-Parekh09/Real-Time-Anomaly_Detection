...
var Slider = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React10.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React10.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React10.useRef(values);
    ...
    return (0, import_jsx_runtime5.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime5.jsx)(Collection.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime5.jsx)(Collection.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime5.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React10.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React10.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React10.useRef(void 0);
...
var SliderVertical = React10.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
...
var SliderImpl = React10.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React10.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React10.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React10.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection(props.__scopeSlider);
    const [thumb, setThumb] = React10.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React10.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime5.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index });
  }
);
var SliderThumbImpl = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime5.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime5.jsx)(Collection.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime5.jsx)(
            Primitive.span,
            {
              role: "slider",
...
var BubbleInput = (props) => {
  ...
  return (0, import_jsx_runtime5.jsx)("input", { style: { display: "none" }, ...inputProps, ref, defaultValue: value });
};
