  ...
  return (
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm px-6 py-3.5 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-1">
        {[['How It Works', '#how-it-works'], ['Architecture', '#architecture'], ['Advantage', '#advantage']].map(([l, h]) => (
      ...
      <div className="flex items-center gap-3">
        <div className="hidden items-center gap-2 bg-green-50 border border-green-200 rounded-full px-3 py-1.5 sm:flex">
        ...
        <button
          type="button"
          onClick={onStart}
          className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-black text-white shadow-sm shadow-blue-600/20 transition-colors hover:bg-blue-700"
        >
          Start
        </button>
      </div>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      <Navbar onStart={() => setStarted(true)} />
